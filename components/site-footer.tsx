export default function SiteFooter() {
  return (
    <footer className="mt-auto flex w-full flex-col items-center gap-4 border-t border-champagne-surface bg-linen-bg px-8 py-10 text-center">
      <h2 className="font-serif text-2xl font-medium italic text-rosewood-ink">
        UndanganJo
      </h2>
